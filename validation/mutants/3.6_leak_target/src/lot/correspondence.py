...
class CorrespondenceSamples(NamedTuple):
    ...
    neighbor_option_ok: np.ndarray  # [N, 4] the admissible set the direction was hashed among
...
def sample_correspondences(
    ...
    if cell_option_ok is not None:
        ...
        cells = patch_cell_index(uv_cand, (height, width), patch_size)
